...
grid on; xlabel('t [s]'); ylabel('ang [deg]'); title('LF-RF')
subplot(1,4,2); plot(t,theta(:,2,1)*180/pi,t,theta(:,2,2)*180/pi); 
grid on; xlabel('t [s]'); ylabel('ang [deg]'); title('RF-RH')
subplot(1,4,3); plot(t,theta(:,3,1)*180/pi,t,theta(:,3,2)*180/pi); 
grid on; xlabel('t [s]'); ylabel('ang [deg]'); title('RH-LH')
subplot(1,4,4); plot(t,theta(:,4,1)*180/pi,t,theta(:,4,2)*180/pi); 
grid on; xlabel('t [s]'); ylabel('ang [deg]'); title('LH-LF')
